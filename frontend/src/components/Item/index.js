...
export default function Item(props) {
    ...
    return (
        <div className="list-group-item-action d-flex align-items-center justify-contenct-between flex-row w-100 mb-3">
            <div className="d-flex">
                <div className="d-flex align-items-center">
                    <img className="p-2 mr-3" src={image} alt={title} width="80"/>
                </div>
                <div>
                    <div className="d-flex align-items-center justify-contenct-between">
